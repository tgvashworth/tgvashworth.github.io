...
summary: "Introduces distra, a Node CLI tool that serves static files and reverse-proxies local servers under friendly hostnames, managing your hosts file automatically."
---
