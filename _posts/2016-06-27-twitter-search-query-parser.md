...
summary: "Building TweetDeck's open-source Twitter search query parser in JavaScript, using a PEG grammar and Canopy to convert queries to an AST and back, with notes on stringification and reversible-parsing tests."
---
